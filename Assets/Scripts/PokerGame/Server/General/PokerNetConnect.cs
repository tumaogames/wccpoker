...
public class PokerNetConnect : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameServerClient.ConnectWithLaunchToken(sharedData.launcherToken, sharedData .operatorID );
    }
    ...
    void OnConnect(ConnectResponse resp)
    {
        ...
        //GameServerClient.SendSpectateStatic(_netInfo.SpectateTableCode); //old
        GameServerClient.SendJoinTableStatic(sharedData .selectedTableCode );
