    ...
    IPointerClickHandler
{
    ...
    private void Select()
    {
        ...
        sharedData.selectedTableCode = ArtGameManager.Instance.selectedTable.tableCode;
        Debug.Log("sharedData.selectedTableCode:" + sharedData.selectedTableCode);
        sharedData.pendingMatchSizeTableCode = sharedData.selectedTableCode;
        GameServerClient.SendJoinTableStatic(sharedData.selectedTableCode, 0);
